...
const Contacts = ({
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col overflow-hidden bg-white">
      <div className="shrink-0 bg-[#eef2ff] px-4 py-3">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#6d28d9] text-sm font-extrabold text-white">
              M
            </div>
            <div>
              <h1 className="text-xl font-bold text-[#0b0b12]">Chats</h1>
          ...
          <div className="flex items-center gap-2 text-[#475569]">
            <span className="flex h-9 w-9 items-center justify-center rounded-full hover:bg-[#e0e7ff]">
      ...
      <div className="shrink-0 border-b border-[#e2e8f0] bg-white px-3 py-2">
        <div className="relative">
          <input
            ...
            className="w-full rounded-lg border-0 bg-[#eef2ff] px-11 py-2.5 text-sm text-[#0b0b12] outline-none placeholder:text-[#64748b] focus:ring-2 focus:ring-[#c7d2fe]"
          />
          <svg
            ...
            return (
              <li key={friend._id}>
                <button
                  ...
                  className={`w-full border-b border-[#e2e8f0] px-4 py-3 text-left transition-colors ${
                    isActive
                      ? "bg-[#eef2ff]"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-3">
                        <h3 className="truncate text-[15px] font-semibold text-[#0b0b12]">
                          {friend.name}
                        </h3>
