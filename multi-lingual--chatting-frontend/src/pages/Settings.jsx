    ...
    <div className="min-h-[calc(100vh-4rem)] bg-[#d1d7db] px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-5xl gap-6">
        <header className="rounded-xl bg-white p-6 shadow-lg">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#54656f]">
            Settings
          </p>
          <h1 className="mt-2 text-3xl font-light text-[#111b21]">
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <section>
              <h2 className="text-sm font-semibold text-[#111b21]">
              ...
              <div className="mt-5 grid gap-4">
                <label className="block text-sm font-semibold text-[#111b21]">
                  Preferred language
                  <select
                    value={preferredLanguage}
                    onChange={(event) => setPreferredLanguage(event.target.value)}
                    className="mt-2 w-full rounded-lg border border-[#e9edef] bg-white px-3 py-2 text-sm text-[#111b21] focus:border-[#00a884] focus:outline-none"
                  >
                ...
                <label className="flex items-start gap-3 rounded-lg border border-[#e9edef] bg-[#f9fafb] px-4 py-3">
                  <input
                    type="checkbox"
                    ...
                    className="mt-1 h-4 w-4 rounded border-[#cfd4d8] text-[#00a884] focus:ring-[#00a884]"
                  />
                  <span>
                    <span className="block text-sm font-semibold text-[#111b21]">
                      Enable multilingual translation
                    </span>
                    <span className="mt-1 block text-sm text-[#667781]">
            ...
            <aside className="rounded-lg border border-[#e9edef] bg-[#f0f2f5] p-5">
              <h3 className="text-sm font-semibold text-[#111b21]">
                What happens next
              </h3>
              <ul className="mt-3 space-y-2 text-sm text-[#54656f]">
                <li>
